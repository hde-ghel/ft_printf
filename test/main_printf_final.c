...
/*   Updated: 2020/01/16 13:47:00 by hde-ghel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
e += 	ft_printf ("|%-0#5x|%-0#5.3x|%-0#5.1x|%-0#5.0x|%-0#5.x|\n", 0,0,0,0,0);
	...
	printf("\n");
	// CONV %F pas obligatoire     g += (ft_printf("%-.5f %LF\n", 5.00, (long double)5.65));
	// CONV %F pas obligatoire     h +=    (printf("%-.5f %LF\n", 5.00, (long double)5.65));
	//printf("\n");
...
/*  FUCKED FLOAT TEST PRINTF GIVING RANDOM ON 0 SAME FOR PRINTF WITH MANTIS !!!!!
